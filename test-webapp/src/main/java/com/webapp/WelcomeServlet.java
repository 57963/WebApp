...
public class WelcomeServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		int weeks = cLatest.get(Calendar.WEEK_OF_YEAR)-cEarliest.get(Calendar.WEEK_OF_YEAR)+1+(53*years);
		for(int week = cEarliest.get(Calendar.DAY_OF_WEEK)==2?-1:0; week<weeks;week++){
